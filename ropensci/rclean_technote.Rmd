---
title: Rclean and Automatng Code Cleaning in R
author: M.K. Lau
...
Thanks to the efforts and helpful feedback from the ROpenSci
Community, the package has recently passed software review and we have
also recently published an article in the Journal of Statistical
Software. The package is hosted through the ROpenSci organization on
Github, and we recommend using the `devtools` library [@R-devtools] to
install directly from the repository (https://github.com/ROpenSci/Rclean).
