...
(cite). To get an idea of what data provenance is, take a look at the
`code_graph` function. The plot that it generates is a graphical
...
methods to use retrospective provenance for R and are currently
working on a project to use it for code cleaning (cite).
...
support the generation of new comments along the lines of "This
generates result C using inputs A and B by conducting processing steps
that do ...".
